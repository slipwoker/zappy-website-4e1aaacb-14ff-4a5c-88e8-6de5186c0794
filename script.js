      ...
      if (window.zappyContactFormLoaded) {
        try {
          ...
          const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
            ...
            body: JSON.stringify({
              websiteId: '4e1aaacb-14ff-4a5c-88e8-6de5186c0794',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "home4sport - סניף מרכז משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
